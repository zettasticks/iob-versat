enum SP_Type {
  ...
  SP_Type_EXPR,
  SP_Type_HIER_ACCESS,
  SP_Type_RANGE_ACCESS,
  SP_Type_DELAY_ACCESS,
  SP_Type_PORT_ACCESS,
  SP_Type_INPUT_DECL,
  SP_Type_VAR_DECL,
...
static String SP_Type_Name(SP_Type in){
  ...
  case SP_Type_HIER_ACCESS: res = "HIER_ACCESS"; didIt = 1; break;
  case SP_Type_RANGE_ACCESS: res = "RANGE_ACCESS"; didIt = 1; break;
  case SP_Type_DELAY_ACCESS: res = "DELAY_ACCESS"; didIt = 1; break;
  case SP_Type_PORT_ACCESS: res = "PORT_ACCESS"; didIt = 1; break;
  case SP_Type_INPUT_DECL: res = "INPUT_DECL"; didIt = 1; break;
  ...
  case SP_Type_VAR_GROUP: res = "VAR_GROUP"; didIt = 1; break;
  ...
  case SP_Type_FUNC_TYPE_NONE: res = "FUNC_TYPE_NONE"; didIt = 1; break;
...
static bool SP_Type_IsExpr(SP_Type in){
  ...
  case SP_Type_FUNC_CALL: res = 0; didIt = 1; break;
  ...
  case SP_Type_RANGE: res = 1; didIt = 1; break;
  case SP_Type_EXPR: res = 0; didIt = 1; break;
  case SP_Type_HIER_ACCESS: res = 0; didIt = 1; break;
  case SP_Type_RANGE_ACCESS: res = 0; didIt = 1; break;
  case SP_Type_DELAY_ACCESS: res = 0; didIt = 1; break;
  case SP_Type_PORT_ACCESS: res = 0; didIt = 1; break;
  case SP_Type_INPUT_DECL: res = 0; didIt = 1; break;
  ...
  case SP_Type_VAR_GROUP: res = 0; didIt = 1; break;
  ...
  case SP_Type_FUNC_TYPE_NONE: res = 0; didIt = 1; break;
...
static int SP_Type_OpCount(SP_Type in){
  int res = {};
  bool didIt = 0;
  switch(in){
  case SP_Type_NIL: res = 0; didIt = 1; break;
  case SP_Type_NOT: res = 1; didIt = 1; break;
  case SP_Type_ADD: res = 2; didIt = 1; break;
  case SP_Type_SUB: res = 2; didIt = 1; break;
  case SP_Type_MUL: res = 2; didIt = 1; break;
  case SP_Type_DIV: res = 2; didIt = 1; break;
  case SP_Type_VAR: res = 0; didIt = 1; break;
  case SP_Type_LITERAL: res = 0; didIt = 1; break;
  case SP_Type_FUNC_CALL: res = 0; didIt = 1; break;
  case SP_Type_AND: res = 2; didIt = 1; break;
  case SP_Type_OR: res = 2; didIt = 1; break;
  case SP_Type_XOR: res = 2; didIt = 1; break;
  case SP_Type_RHL: res = 2; didIt = 1; break;
  case SP_Type_RHR: res = 2; didIt = 1; break;
  case SP_Type_SHL: res = 2; didIt = 1; break;
  case SP_Type_SHR: res = 2; didIt = 1; break;
  case SP_Type_RANGE: res = 2; didIt = 1; break;
  case SP_Type_EXPR: res = 0; didIt = 1; break;
  case SP_Type_HIER_ACCESS: res = 0; didIt = 1; break;
  case SP_Type_RANGE_ACCESS: res = 0; didIt = 1; break;
  case SP_Type_DELAY_ACCESS: res = 0; didIt = 1; break;
