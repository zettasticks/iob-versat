...
#{templateArgument "int" "totalExternalMemory"}
#{templateArgument "int" "nIOs"}
#{templateArgument "int" "nInputs"}
#{templateArgument "Options" "opts"}
#{templateArgument "Array<ExternalMemoryInterface>" "externalMemory"}
#{templateArgument "Array<Wire>" "states"}
#{templateArgument "Array<String>" "statesHeader"}
#{templateArgument "Array<WireExtra>" "allConfigsVerilatorSide"}
#{templateArgument "int" "numberDelays"}
